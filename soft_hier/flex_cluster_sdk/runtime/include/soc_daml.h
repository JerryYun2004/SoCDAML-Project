...
#include <stdint.h>
#include <stddef.h>
#include "flex_cluster_arch.h"  // provides ARCH_NUM_* macros
...
#error "ARCH_NUM_CLUSTER_X not defined. Generate flex_cluster_arch.h via `make hw` and include paths."
#endif
#ifndef ARCH_NUM_CLUSTER_Y
#error "ARCH_NUM_CLUSTER_Y not defined. Generate flex_cluster_arch.h via `make hw` and include paths."
#endif
#ifndef ARCH_NUM_CORE_PER_CLUSTER
#error "ARCH_NUM_CORE_PER_CLUSTER not defined. Generate flex_cluster_arch.h via `make hw` and include paths."
#endif
...
/* Tune if you expect longer free lists / more common blocks */
